...
class ProductTemplate(models.Model):
    ...
    website_public_price = fields.Float('Website public price', compute='_website_price',
    ...
    def _default_website_meta(self):
        ...
        res['default_opengraph']['og:image'] = res['default_twitter'][
            'twitter:image'] = "/web/image/product.template/%s/image" % (self.id)
        return res
